...
int main(int argc, char *argv[]) {
  ...
  MemoryProfiler::logSnapshot("Application Startup");
  ...
  // DEBUG: Diagnose Struct Sizes
  qDebug() << "=== MEMORY DIAGNOSTICS ===";
  qDebug() << "sizeof(QString):" << sizeof(QString);
  qDebug() << "sizeof(QVector<int>):" << sizeof(QVector<int>);
  qDebug() << "sizeof(ContractData):" << sizeof(ContractData);
  qDebug() << "sizeof(MasterContract):" << sizeof(MasterContract);
  qDebug() << "sizeof(MarketData::UnifiedState):"
           << sizeof(MarketData::UnifiedState);
  qDebug() << "sizeof(NSEFORepository):" << sizeof(NSEFORepository);
  qDebug() << "sizeof(MasterFileParser):" << sizeof(MasterFileParser);
  qDebug() << "===========================";
  ...
  MemoryProfiler::logSnapshot("Pre-Master Loading");
  ...
  QObject::connect(
      splash, &SplashScreen::readyToClose, [splash, config, foundPath]() {
        ...
        MemoryProfiler::logSnapshot("Post-Master Loading");
        ...
        loginService->setCompleteCallback([loginWindow, mainWindow,
          ...
          MemoryProfiler::logSnapshot("Post-Login Complete");
