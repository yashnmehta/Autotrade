...
private:
    ...
    QVariant displayForColumn(const StrategyInstance& instance, Column column) const;
    QVariant sortValueForColumn(const StrategyInstance& instance, Column column) const;
