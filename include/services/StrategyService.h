...
public:
    ...
    qint64 createInstance(const QString& name,
    ...
    bool modifyParameters(qint64 instanceId,
                          const QVariantMap& parameters,
                          double stopLoss,
                          double target,
                          QString* outError = nullptr);

    bool updateMetrics(qint64 instanceId,
                       double mtm,
                       int activePositions,
                       int pendingOrders);
...
signals:
    ...
    void metricsUpdated(qint64 instanceId, double mtm, double stopLoss, double target);
