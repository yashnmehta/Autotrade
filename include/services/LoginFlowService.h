...
public:
  ...
  void executeLogin(const QString &mdAppKey, const QString &mdSecretKey,
                    const QString &iaAppKey, const QString &iaSecretKey,
                    const QString &loginID, bool downloadMasters,
                    const QString &baseURL, const QString &source = "WEBAPI");
...
private:
  ...
  bool m_mastersPhaseStarted = false;
  bool m_websocketPhaseStarted = false;
